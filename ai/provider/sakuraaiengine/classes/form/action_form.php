...
use aiprovider_sakuraaiengine\helper;
...
class action_form extends action_settings_form {
    ...
    protected function definition(): void {
        ...
        $this->providername = $this->_customdata['providername'] ?? 'aiprovider_sakuraaiengine';
    ...
    public function get_data(): ?\stdClass {
        ...
        if ($data) {
            ...
            // Keep valid falsy values (0/false) while removing null and empty strings.
            $data = (object) array_filter((array) $data, static function($value): bool {
    ...
    public function validation($data, $files): array {
        ...
        if (!empty($data['modelextraparams'])) {
            ...
            if (json_last_error() !== JSON_ERROR_NONE) {
                $errors['modelextraparams'] = get_string('invalidjson', 'aiprovider_sakuraaiengine');
            }
        }
    ...
    protected function add_model_fields(int $modeltype): void {
        ...
        if (!empty($this->actionconfig['model']) &&
            ...
            $defaultmodel = $this->actionconfig['model'] ?? 'gpt-oss-120b';
        }
        ...
        $mform->addElement('hidden', 'model', $this->actionconfig['model'] ?? 'gpt-oss-120b');
